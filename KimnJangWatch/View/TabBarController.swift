...
class TabBarController: UITabBarController {
  ...
  override func viewDidLoad() {
    ...
    worldTimeVC.tabBarItem = UITabBarItem(
      title: "세계 시간",
    ...
    let testNotificationVC = UINavigationController(
      rootViewController: TestNotificationViewController()
    )
    testNotificationVC.tabBarItem = UITabBarItem(
      title: "알림 Test",
      image: UIImage(systemName: "globe"),
      tag: 4
    )
